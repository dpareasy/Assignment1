...
As regarding the third point, the developer has encountered some issues with the function `disj_inds_of_class(self, class_name)` of [armor_manipulation_client.py](https://github.com/EmaroLab/armor_py_api/scripts/armor_api). To fix this problem a new function have been created:
